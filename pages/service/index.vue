    ...
    <div class="w-full">
      ...
      <div class="flex flex-col items-center justify-center">
        ...
        <div class="mt-20 lg:mt-32 w-full">
            ...
            <div class="flex flex-wrap justify-center items-center lg:gap-x-20 lg:gap-y-10 gap-12 mt-20 lg:mt-8">
              <div
                ...
                <div
                  ...
                  <NuxtLink to="#"
                    class="py-2 px-14 text-center font-semibold text-pretty border-2 hover:border-indigo-600 text-white transition-all duration-500 rounded-xl hover:text-indigo-600 bg-indigo-600 hover:bg-transparent">
                    رزرو</NuxtLink>
                  <NuxtLink to="#"
                    class="text-indigo-700 text-lg font-semibold text-pretty flex items-center justify-center">
                    بیشتر بدانید
          ...
          <div class="flex justify-center items-center mt-40 relative w-full overflow-hidden">
            ...
            <div class="absolute md:-left-0 lg:left-60">
              <div class="container h-[850px] md:h-[800px] lg:w-[130%] bg-white/70 backdrop-blur-sm p-5 lg:mt-5">
                ...
                <p class="text-4xl font-semibold text-pretty tracking-normal mt-5 leading-snug lg:leading-none">قرار
                  رزرو بر اساس جدول زمان</p>
                <div class="flex flex-col justify-center space-y-5 md:space-y-1 mt-8 md:mt-5">
                  <div class="flex items-center justify-between p-2 md:p-6">
                    ...
                    <NuxtLink to="#"
                      class="text-indigo-700 text-base font-semibold text-pretty text-center tracking-tighter">
                      اکنون ثبت کن
                    </NuxtLink>
                  </div>
                  ...
                  <div class="flex items-center justify-between">
                    ...
                    <NuxtLink to="#"
                      class="py-2 px-10 text-center text-sm md:text-balance font-semibold border-2 hover:border-indigo-600 text-white transition-all duration-500 rounded-xl hover:text-indigo-600 bg-indigo-600 hover:bg-transparent text-nowrap">
                      قرار گذاشتن
                    </NuxtLink>
                  </div>
                </div>
